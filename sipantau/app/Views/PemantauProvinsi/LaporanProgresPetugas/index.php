                        ...
                        foreach ($dataPetugas as $petugas):
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="col-nama sticky bg-white px-4 py-3 text-sm border-r border-gray-200">
                                    <a href="<?= base_url('pemantau-provinsi/laporan-progress-petugas/detail/' . $petugas['id_pcl']) ?>"
                                        class="font-medium text-blue-600 hover:text-blue-800 hover:underline">
                                        <div><?= esc($petugas['nama_user']) ?></div>
                                ...
                                <td
                                    ...
                                    <?= number_format($petugas['total_realisasi']) ?>
...
<script>
    function updateFilters() {
        ...
        window.location.href = '<?= base_url('pemantau-provinsi/laporan-progress-petugas') ?>?' + params.toString();
    }
    ...
    function exportCSV() {
        ...
        window.location.href = '<?= base_url('pemantau-provinsi/laporan-progress-petugas/export-csv') ?>?' + params.toString();
    }
