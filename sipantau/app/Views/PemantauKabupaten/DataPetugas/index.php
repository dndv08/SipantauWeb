                    ...
                    <?php foreach ($dataPetugas as $index => $petugas): ?>
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-sm border border-gray-300">
                                <a href="<?= base_url('pemantau-kabupaten/data-petugas/detail/' . $petugas['sobat_id']) ?>"
...
<script>
    function sortTable(column) {
        ...
        // PERBAIKAN: Ganti ke route pemantau kabupaten
        window.location.href = '<?= base_url('pemantau-kabupaten/data-petugas') ?>?' + urlParams.toString();
    }
