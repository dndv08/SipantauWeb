            ...
            <nav class="flex-1 overflow-y-auto scrollbar-thin py-4 px-3 pb-20">
                <div class="space-y-1">
                    ...
                    <a href="<?= base_url('adminsurvei-kab/assign-sub-sls') ?>"
                        class="sidebar-link <?= ($active_menu ?? '') == 'assign-sub-sls' ? 'active' : '' ?>">
                        <i class="fas fa-users w-5"></i>
                        <span class="ml-3">Assignment Petugas SLS/Sub-SLS</span>
                    </a>

                    <!-- Usaha SBR -->
                    <a href="<?= base_url('adminsurvei-kab/usaha-sbr') ?>"
                        class="sidebar-link <?= ($active_menu ?? '') == 'usaha-sbr' ? 'active' : '' ?>">
                        <i class="fas fa-store w-5"></i>
                        <span class="ml-3">Usaha SBR</span>
                    </a>

                    <!-- View Hasil Assignment -->
                    <a href="<?= base_url('adminsurvei-kab/view-assign-sub-sls') ?>"
                        class="sidebar-link <?= ($active_menu ?? '') == 'view-assign-sub-sls' ? 'active' : '' ?>">
                        <i class="fas fa-clipboard-list w-5"></i>
                        <span class="ml-3">View Hasil Assignment</span>
                    </a>
                    ...
                    <a href="<?= base_url('adminsurvei-kab/monitoring-titik') ?>"
