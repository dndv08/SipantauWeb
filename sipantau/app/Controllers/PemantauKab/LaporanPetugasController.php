...
class LaporanPetugasController extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Pemantau Kabupaten - Laporan Petugas',
        ...
        return view('PemantauKabupaten/LaporanPetugas/index', $data);
    }
    ...
    /**
     * Get laporan petugas dengan pagination - FILTERED BY KABUPATEN
     */
    private function getLaporanPetugas($idKegiatanProses, $idKabupaten, $search, $dateHeaders, $perPage)
    {
        $db = \Config\Database::connect();
    ...
    public function exportCSV()
    {
        ...
        $dataPetugas = $this->getLaporanPetugasAll($idKegiatanProses, $idKabupaten, $search, $dateHeaders);
     ...
     */
    private function getLaporanPetugasAll($idKegiatanProses, $idKabupaten, $search, $dateHeaders)
    {
        $db = \Config\Database::connect();
        $builder = $db->table('pcl')
